  ...
  var DICT = {
    "zh": {
      ...
      "sup": {
        ...
        "cap1MockTag": "商機雷達",
        "cap1ScrollAria": "商機與品項缺口示意表，可左右捲動",
        "cap1TableAria": "商機與品項缺口示例",
        "cap1ThItem": "需求品項",
        "cap1ThArea": "配送區域",
        "cap1ThFreq": "頻率",
        "cap1ThStatus": "狀態",
        "cap1Row1Item": "青江菜 120 kg",
        "cap1Row1Area": "台北市",
        "cap1Row1Freq": "每週 3 次",
        "cap1Row1Status": "新商機",
        "cap1Row2Item": "去骨雞腿 80 kg",
        "cap1Row2Area": "新北市",
        "cap1Row2Freq": "每週 2 次",
        "cap1Row2Status": "已查看",
        "cap1Row3Item": "品項缺口：甜椒",
        "cap1Row3Area": "服務區域內",
        "cap1Row3Freq": "近 90 天 16 次需求",
        "cap1Row3Status": "尚未上架",
        ...
        "cap2MockTag": "報價與訂單",
        "cap2ScrollAria": "報價與訂單狀態示意表，可左右捲動",
        "cap2TableAria": "報價與訂單狀態示例",
        "cap2ThSummary": "需求摘要",
        "cap2ThTotal": "總報價",
        "cap2ThLeadTime": "交期",
        "cap2ThStatus": "狀態",
        "cap2Row1Summary": "葉菜類 3 品項",
        "cap2Row1LeadTime": "2 個工作天",
        "cap2Row1Status": "已接受",
        "cap2Row2Summary": "冷凍肉品 2 品項",
        "cap2Row2Total": "待回覆",
        "cap2Row2Status": "待報價",
        "cap2Row3Summary": "訂單 #8F21A0",
        "cap2Row3Status": "待確認",
        "cap2Note": "訂單確認備妥後，可由供應商按下「確認出貨」，並保留出貨紀錄。",
        ...
        "cap3MockTag": "定價助手 · 需求預測",
        "cap3ScrollAria": "定價與需求預測示意表，可左右捲動",
        "cap3TableAria": "定價與需求預測示例",
        "cap3ThItem": "品項",
        "cap3ThMyPrice": "我的價格",
        "cap3ThMarket": "同區行情",
        "cap3ThRestock": "下週備貨建議",
        "cap3Row1Item": "青江菜",
        "cap3Row2Item": "小白菜",
        "cap3Row3Item": "甜椒",
        "cap3Row3MyPrice": "尚未上架",
        "cap3Row3Restock": "需求成長 +12%",
        "cap3Note": "預測依平台需求紀錄推估，實際備貨仍需依供應能力與市場狀況判斷。",
        ...
        "cap4MockTag": "客戶與評價",
        "cap4ScrollAria": "客戶與評價示意表，可左右捲動",
        "cap4TableAria": "客戶與評價示例",
        "cap4ThCustomer": "客戶",
        "cap4ThFreq": "下單頻率",
        "cap4ThLastOrder": "最近訂單",
        "cap4ThStatus": "合作狀況",
        "cap4Row1Customer": "禾日餐飲",
        "cap4Row1Freq": "每週",
        "cap4Row1LastOrder": "3 天前",
        "cap4Row1Status": "穩定回購",
        "cap4Row2Customer": "好食團膳",
        "cap4Row2Freq": "每兩週",
        "cap4Row2LastOrder": "26 天前",
        "cap4Row2Status": "可能流失",
        "cap4Row3Customer": "山海小館",
        "cap4Row3Freq": "首次合作",
        "cap4Row3LastOrder": "7 天前",
        "cap4Row3Status": "新客戶",
        "cap4PillRating": "交易評價 4.8 / 5",
        "cap4PillReviews": "商店評價 12 則",
    ...
    "en": {
      ...
      "sup": {
        ...
        "mockCaption": "Product UI mockup · Sample data",
        ...
        "cap1MockTag": "Lead radar",
        "cap1ScrollAria": "Leads and catalog gaps mockup table, scrolls horizontally",
        "cap1TableAria": "Leads and catalog gaps example",
        "cap1ThItem": "Requested item",
        "cap1ThArea": "Delivery area",
        "cap1ThFreq": "Frequency",
        "cap1ThStatus": "Status",
        "cap1Row1Item": "Bok choy 120 kg",
        "cap1Row1Area": "Taipei City",
        "cap1Row1Freq": "3× weekly",
        "cap1Row1Status": "New lead",
        "cap1Row2Item": "Boneless chicken thigh 80 kg",
        "cap1Row2Area": "New Taipei City",
        "cap1Row2Freq": "2× weekly",
        "cap1Row2Status": "Viewed",
        "cap1Row3Item": "Catalog gap: bell pepper",
        "cap1Row3Area": "In your service area",
        "cap1Row3Freq": "16 requests in 90 days",
        "cap1Row3Status": "Not listed",
        ...
        "cap2MockTag": "Quotes and orders",
        "cap2ScrollAria": "Quote and order status mockup table, scrolls horizontally",
        "cap2TableAria": "Quote and order status example",
        "cap2ThSummary": "Request",
        "cap2ThTotal": "Quote total",
        "cap2ThLeadTime": "Lead time",
        "cap2ThStatus": "Status",
        "cap2Row1Summary": "Leafy greens, 3 items",
        "cap2Row1LeadTime": "2 business days",
        "cap2Row1Status": "Accepted",
        "cap2Row2Summary": "Frozen meat, 2 items",
        "cap2Row2Total": "Not sent",
        "cap2Row2Status": "Pending quote",
        "cap2Row3Summary": "Order #8F21A0",
        "cap2Row3Status": "Awaiting confirmation",
        "cap2Note": "Once the order is ready, the supplier taps \"Confirm shipment\" and the shipping record is kept on file.",
        ...
        "cap3MockTag": "Pricing assistant · Demand forecast",
        "cap3ScrollAria": "Pricing and demand forecast mockup table, scrolls horizontally",
        "cap3TableAria": "Pricing and demand forecast example",
        "cap3ThItem": "Item",
        "cap3ThMyPrice": "My price",
        "cap3ThMarket": "Local range",
        "cap3ThRestock": "Next week's stock",
        "cap3Row1Item": "Bok choy",
        "cap3Row2Item": "Baby bok choy",
        "cap3Row3Item": "Bell pepper",
        "cap3Row3MyPrice": "Not listed",
        "cap3Row3Restock": "Demand +12%",
        "cap3Note": "Forecasts are estimates based on platform demand records. Actual stocking still depends on your supply capacity and market conditions.",
        ...
        "cap4MockTag": "Customers and ratings",
        "cap4ScrollAria": "Customers and ratings mockup table, scrolls horizontally",
        "cap4TableAria": "Customers and ratings example",
        "cap4ThCustomer": "Customer",
        "cap4ThFreq": "Order frequency",
        "cap4ThLastOrder": "Last order",
        "cap4ThStatus": "Status",
        "cap4Row1Customer": "Heri Dining",
        "cap4Row1Freq": "Weekly",
        "cap4Row1LastOrder": "3 days ago",
        "cap4Row1Status": "Steady repeat",
        "cap4Row2Customer": "Haoshi Catering",
        "cap4Row2Freq": "Biweekly",
        "cap4Row2LastOrder": "26 days ago",
        "cap4Row2Status": "At risk",
        "cap4Row3Customer": "Shanhai Bistro",
        "cap4Row3Freq": "First order",
        "cap4Row3LastOrder": "7 days ago",
        "cap4Row3Status": "New customer",
        "cap4PillRating": "Transaction rating 4.8 / 5",
        "cap4PillReviews": "12 store reviews",
